      ...
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8 fade">
        ...
        <div className="mb-4 grid grid-cols-2 gap-4 sm:grid-cols-3 md:mb-8 md:grid-cols-4 md:gap-6 xl:gap-8 fade">
          {[
            {
              href: '#',
              imgSrc: '/img/tanbotohatake_TP_V4.jpg',
              imgAlt: 'Photo by Minh Pham',
              text: '水田',
            },
            {
              href: '#',
              imgSrc: '/img/kissaten27jpegsrgb__92A0484-e_TP_V4.jpg',
              imgAlt: 'Photo by Magicle',
              text: '稲刈り',
            },
            {
              href: '#',
              imgSrc: '/img/スクリーンショット 2024-01-30 14.42.42.png',
              imgAlt: 'Photo by Martin Sanchez',
              text: '機械',
            },
            {
              href: '#',
              imgSrc: './img/ZUBOTTYDSC_0981_TP_V4.jpg',
              imgAlt: 'Photo by Lorenzo Herrera',
              text: '畑作',
            },
          ].map((item, index) => (
            <a
