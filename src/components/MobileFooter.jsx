...
//                 </div>         
//                 <div>
//                   <Link to="/mobilewheat" class="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">春・秋麦</Link>
//                 </div>         
//                 <div>
        ...
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div class="mb-16 grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-6 lg:gap-8">
            ...
            <div>
              ...
              <nav class="flex flex-col gap-4">
                <div>
                  <Link to="/mobilemachine" class="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">機械の詳細</Link>
                </div>
                <div>
                  <Link to="/companyoverview" class="text-gray-500 transition duration-100 hover:text-indigo-500 active:text-indigo-600">会社概要</Link>
                </div>
